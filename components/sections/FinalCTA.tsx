...
export function FinalCTA() {
  return (
    <section id="begin" className="surface-cream relative text-navy">
      <div className="mx-auto max-w-[1200px] px-6 py-20 md:px-16 md:py-40">
        <Reveal>
          <p className="font-mono text-[12px] tracking-[0.04em] text-navy/70 md:text-[13px]">
            /t1 align
          </p>
          ...
          <p className="mt-8 max-w-[60ch] font-mono text-[15px] leading-[1.6] text-navy/85 md:mt-10 md:text-[16px]">
          ...
          <div className="mt-10 md:mt-12">
            <CommandCTA href="mailto:hello@vectisbuild.co" tone="on-cream" size="lg" className="min-h-[44px] items-center">
              begin engagement
            </CommandCTA>
          </div>
        </Reveal>
